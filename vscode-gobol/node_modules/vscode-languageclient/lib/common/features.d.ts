...
interface NotificationEvent<P extends {
...
export interface AboutToSendNotificationEvent<P extends {
    textDocument: TextDocumentIdentifier;
}> extends NotificationEvent<P> {
}
export interface NotificationSentEvent<P extends {
    textDocument: TextDocumentIdentifier;
}> extends NotificationEvent<P> {
}
/**
...
export declare abstract class TextDocumentEventFeature<P extends {
    ...
    private _onAboutToSendNotification;
    ...
    get onAboutToSendNotification(): VEvent<AboutToSendNotificationEvent<P>>;
    ...
    get onNotificationSent(): VEvent<NotificationSentEvent<P>>;
...
export declare enum DiagnosticCollectionSource {
    push = "push",
    pull = "pull"
}
/**
 ...
 */
export declare class DefaultDiagnosticCollectionProvider implements DiagnosticCollectionProvider {
    create(name: string | undefined, _source: DiagnosticCollectionSource): DiagnosticCollection;
    dispose(collection: DiagnosticCollection, _source: DiagnosticCollectionSource): void;
}
