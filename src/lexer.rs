...
impl Lexer {
    pub fn new(source: impl Into<String>) -> Self {
        ...
        let kw = [
            "if", "else", "for", "return", "int", "float", "str", "func", "var", "val", "import",
            "in", "as", "true", "false", "while", "break", "continue", "from", "self", "export",
            "struct", "impl", "new", "match", "convert", "extern", "trait", "enum", "lambda",
        ];
        for k in &kw {
