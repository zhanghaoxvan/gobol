...
import { FeatureClient, TextDocumentEventFeature, DynamicFeature, NextSignature, TextDocumentSendFeature, NotifyingFeature, RegistrationData, DynamicDocumentFeature, NotificationSentEvent, AboutToSendNotificationEvent } from './features';
...
export declare class DidChangeTextDocumentFeature extends DynamicDocumentFeature<TextDocumentChangeRegistrationOptions, TextDocumentSynchronizationMiddleware> implements DidChangeTextDocumentFeatureShape {
    ...
    private readonly _onAboutToSendNotification;
    ...
    get onAboutToSendNotification(): Event<AboutToSendNotificationEvent<DidChangeTextDocumentParams>>;
    get onNotificationSent(): Event<NotificationSentEvent<DidChangeTextDocumentParams>>;
    ...
    private callback;
    aboutToSendNotification(textDocument: TextDocument, type: ProtocolNotificationType<DidChangeTextDocumentParams, TextDocumentRegistrationOptions>, params: DidChangeTextDocumentParams): void;
